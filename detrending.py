...
c1p1.Update()
'''
date , counts = numpy.loadtxt('/Users/spenceraxani/Documents/499_Thesis/data/datapack/binned_total_counts.txt', unpack=True)
date , pressure = numpy.loadtxt('/Users/spenceraxani/Documents/499_Thesis/data/datapack/binned_pressure.txt', unpack=True)
date , temperature = numpy.loadtxt('/Users/spenceraxani/Documents/499_Thesis/data/datapack/binned_temperature.txt', unpack=True)
mean_pressure = np.mean(pressure)
mean_temperature = np.mean(temperature)
try:
	os.remove('/Users/spenceraxani/Documents/499_Thesis/data/datapack/data_detrended.txt')
	os.remove('/Users/spenceraxani/Documents/499_Thesis/data/datapack/data_detrended_b.txt')
except OSError:
	pass
outfile= open('/Users/spenceraxani/Documents/499_Thesis/data/datapack/data_detrended.txt','a')
outfileb= open('/Users/spenceraxani/Documents/499_Thesis/data/datapack/data_detrended_b.txt','a')
x1 = array("d",date)
