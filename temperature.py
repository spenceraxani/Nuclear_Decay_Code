...
getcontext().prec = 12
try:
	os.remove('/Users/spenceraxani/Documents/499_Thesis/data/datapack/temperture_file.txt')
	os.remove('/Users/spenceraxani/Documents/499_Thesis/data/datapack/humidity_file.txt')
except OSError:
	pass
temp = open('/Users/spenceraxani/Documents/499_Thesis/data/datapack/Temperature.txt', 'r')
counter1 = 0
for line in temp:
	column = line.split('\t')
	...
	if counter1 == 25:
		...
		if columns[-1] == "9":
			...
			if year == 2013:
				temp_out = open('/Users/spenceraxani/Documents/499_Thesis/data/datapack/temperture_file.txt', 'a')
				temp_out.write(str(56293.50 + proper_time) + "\t" + str(temperature) + "\n")
				hum_out = open('/Users/spenceraxani/Documents/499_Thesis/data/datapack/humidity_file.txt', 'a')
